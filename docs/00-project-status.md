...
| 15 | [图标工具栏与 Mermaid 兼容性](15-toolbar-icons-and-mermaid.md) | 本地验收完成；233 UT / 集成、46 浏览器流程与原始图示复核通过 |
...
| Biome、Husky、CI 与 UT 门禁 | 本轮本地通过；远程见对应 main CI/CD | 233 UT / 集成，四项覆盖率 100 / 98.68 / 100 / 100%，见 15 |
| 阅读界面与 Obsidian 兼容性 | 本地已验证 | 46 浏览器测试，明暗/移动端无障碍验证通过；移动导航与最近更新见 13、14，图标与图示见 15 |
| 图标工具栏与 Mermaid 显示 | 已实现并本地验证 | 15；全 Lucide 图标、键盘/悬停提示、SVG 换行与固有尺寸修复，原始样例复核通过 |
...
均已通过。初始验证见 05，交互证据见 10，最新身份修复及覆盖分母见 12；启动和部署
